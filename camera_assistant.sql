...
--
-- Current Database: `camera_assistant`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `camera_assistant` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;

USE `camera_assistant`;
...
CREATE TABLE `expert_setting_statistics` (
  ...
  `shutter_min` varchar(20) DEFAULT NULL,
  `shutter_max` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `expert_setting_statistics` VALUES (1,'food','bright',200,'1/120','f/4.0','50mm','0.0','5500K','2026-05-16 12:44:41',50,2000,'1/6','1/640'),(2,'food','normal',320,'1/60','f/2.8','50mm','+0.3','4000K','2026-05-16 12:44:41',64,3200,'1/6','1/604'),(3,'food','dark',400,'1/80','f/2.0','50mm','+0.7','3200K','2026-05-16 12:44:41',80,3200,'1/5','1/640'),(4,'landscape','bright',100,'1/444','f/11','24mm','-0.3','5500K','2026-05-16 12:44:41',50,453,'1/1','1/2000'),(5,'landscape','normal',100,'1/320','f/8.0','24mm','0.0','5500K','2026-05-16 12:44:41',50,640,'1.3s','1/2000'),(6,'landscape','dark',100,'1/200','f/5.6','24mm','+0.3','6500K','2026-05-16 12:44:41',50,800,'3.97s','1/1993'),(7,'night','bright',400,'1/250','f/5.6','35mm','-0.7','4000K','2026-05-16 12:44:41',100,2175,'1.133s','1/675'),(8,'night','normal',400,'1/50','f/4.0','35mm','-0.3','3800K','2026-05-16 12:44:41',100,6400,'30s','1/500'),(9,'night','dark',500,'1/3','f/2.8','35mm','0.0','3500K','2026-05-16 12:44:41',100,6400,'30s','1/315'),(10,'contrast','bright',200,'1/200','f/8.0','50mm','-1.0','5500K','2026-05-16 12:44:41',50,1600,'1/8','1/2478'),(11,'contrast','normal',200,'1/200','f/5.6','50mm','-0.7','5200K','2026-05-16 12:44:41',50,2500,'1/3','1/2000'),(12,'contrast','dark',270,'1/125','f/4.0','50mm','-0.3','5000K','2026-05-16 12:44:41',64,4000,'1/2','1/2000'),(13,'portrait','bright',200,'1/200','f/2.8','85mm','0.0','5500K','2026-05-16 12:44:41',100,1600,'1/20','1/1600'),(14,'portrait','normal',250,'1/200','f/1.8','85mm','+0.3','5000K','2026-05-16 12:44:41',100,4000,'1/20','1/2000'),(15,'portrait','dark',320,'1/125','f/1.4','85mm','+0.7','3500K','2026-05-16 12:44:41',100,6400,'1/20','1/1250');
...
-- Dump completed on 2026-07-15 23:19:07
